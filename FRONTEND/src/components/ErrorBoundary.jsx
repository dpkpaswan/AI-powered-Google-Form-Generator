          ...
          <div className="text-center p-8 max-w-md">
            ...
            <div className="flex justify-center items-center mt-6">
              <button
                ...
                className="bg-primary text-primary-foreground font-medium py-2 px-4 rounded flex items-center gap-2 transition-smooth shadow-elevation-1 hover:opacity-90"
              >
