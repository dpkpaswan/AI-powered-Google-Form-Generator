...
const Login = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      setError(null);
      setIsLoading(true);
      await beginGoogleLogin(); // should redirect
    } catch (err) {
      setIsLoading(false);
      ...
      <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="bg-card rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            <div className="relative inline-flex items-center justify-center w-20 h-20 bg-primary/10 rounded-2xl mb-5">
              <Icon name="Sparkles" size={36} color="var(--color-primary)" />
            ...
            <p className="text-sm text-muted-foreground">
              Connect your Google account to create forms directly in your Drive.
            </p>
          </div>
